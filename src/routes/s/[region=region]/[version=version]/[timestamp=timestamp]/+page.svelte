...
<dialog id="my_modal_1" class="modal modal-bottom sm:modal-middle" class:modal-open={modalVisible}>
  <form method="dialog" class="modal-box">
    ...
    <p class="py-2">
      ...
      seconds are 0) instead of the exact timestamp from the steam api. Please make sure you use the
      exact timestamp if you want to share your data with us on reddit.
    </p>
